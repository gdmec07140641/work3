...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calculatorButton=(Button)findViewById(R.id.s);
        weightEditText=(EditText)findViewById(R.id.d);
        manCheckBox=(CheckBox)findViewById(R.id.g);
        womanCheckBox=(CheckBox)findViewById(R.id.h);
        resultTextView=(TextView)findViewById(R.id.ss);
    }
